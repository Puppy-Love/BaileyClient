        ...
        public void setTitle(@SuggestionType String title) {
            ...
            switch (title) {
                case 空气:
                    ...
                    setIconBackgroundColor(0xFF7F9EE9);
                    break;
                case 舒适度:
                    setIcon(R.drawable.ic_comf);
                    setIconBackgroundColor(0xFFE99E3C);
                    break;
                case 洗车:
                    setIcon(R.drawable.ic_cw);
                    setIconBackgroundColor(0xFF62B1FF);
                    break;
                case 穿衣:
                    setIcon(R.drawable.ic_drsg);
                    setIconBackgroundColor(0xFF8FC55F);
                    break;
                case 感冒:
                    setIcon(R.drawable.ic_flu);
                    setIconBackgroundColor(0xFFF98178);
                    break;
                case 运动:
                    setIcon(R.drawable.ic_sport);
                    setIconBackgroundColor(0xFFB3CA60);
                    break;
                case 旅游:
                    setIcon(R.drawable.ic_trav);
                    setIconBackgroundColor(0xFFFD6C35);
                    break;
                case 紫外线:
                    setIcon(R.drawable.ic_uv);
                    setIconBackgroundColor(0xFFF0AB2A);
                    break;
                default:
                    setIcon(R.drawable.ic_air);
                    setIconBackgroundColor(0xFF7F9EE9);
