...
import com.min.bailey.client.di.component.DaggerGirlItemComponent;
 ...
 */
public class GirlItemFragment extends BaseFragment<GirlItemPresenter>
        implements GirlItemContract.View,
        BaseQuickAdapter.RequestLoadMoreListener,
        SwipeRefreshLayout.OnRefreshListener {

    @BindView(R.id.girl_item_recycler)
    RecyclerView mRecyclerView;
    @BindView(R.id.girl_item_refresh)
    SwipeRefreshLayout mRefresh;
    Unbinder unbinder;

    public static GirlItemFragment newInstance() {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerGirlItemComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .girlItemModule(new GirlItemModule(this))
                .build()
                .inject(this);
    }
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_girl_item, container, false);
    }

    @Override
    public void initData(@Nullable Bundle savedInstanceState) {
        mPresenter.initAdapter();
        mPresenter.getDouBanGirl(true);
    }
    ...
    public void onLoadMoreRequested() {
        mPresenter.getDouBanGirl(false);
