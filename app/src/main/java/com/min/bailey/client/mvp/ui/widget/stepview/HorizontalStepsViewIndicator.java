package com.min.bailey.client.mvp.ui.widget.stepview;
...
import com.min.bailey.client.mvp.ui.widget.stepview.bean.StepBean;

import java.util.ArrayList;
import java.util.List;

/**
 * @describe StepsViewIndicator 指示器
 */
public class HorizontalStepsViewIndicator extends View
{
    ...
    private void init()
    {
        ...
        mCircleRadius = 0.22f * defaultStepIndicatorNum;
        //线与线之间的间距    set mLinePadding
        mLinePadding = 2f * defaultStepIndicatorNum;

        mCompleteIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_complted);//已经完成的icon
        mAttentionIcon = ContextCompat.getDrawable(getContext(), R.drawable.ic_attention_one);//正在进行的icon
