...
import com.min.bailey.client.app.data.entity.IBaileyWeather;
...
public class DynamicWeatherView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    private IBaileyWeather originWeather;
    int fromColor;
    ...
    public IBaileyWeather getOriginWeather() {
        return originWeather;
    }

    public void setOriginWeather(IBaileyWeather originWeather) {
